...
public class Calculos_CorrecaoFosforo{
    public double quantidadeAplicar(double teor_fosforoAtingir,Integer fonte_fosforo, double teor_fosforo,double eficiencia_fosforo){
        ...
        return((teor_fosforoAtingir - teor_fosforo)*2*2.29) / (eficiencia_fosforo / 100) * (100 / array_resultado[fonte_fosforo-1]);
   ...
   public double custoFosforo(double fonte_fosforo,double quantidade_aplicar, double valor_superfosfato_simples){
    ...
    public double calcio_Adicional(double quantidade_aplicar, Integer fonte_fosforo){
   ...
   public double enxofre_Adicional(double quantidade_aplicar, Integer fonte_fosforo){
        double[] array_resultado = {0,quantidade_aplicar*0.1,quantidade_aplicar*0.0,quantidade_aplicar*0.00,
            quantidade_aplicar*0.0,quantidade_aplicar*0.15,quantidade_aplicar*0.0,quantidade_aplicar*0.0,quantidade_aplicar*0.0,quantidade_aplicar*0.0,quantidade_aplicar*0.0,quantidade_aplicar*0.0,quantidade_aplicar*0.11};
            if(fonte_fosforo < 0 || fonte_fosforo>12){
                return 0.0;
            }
        return array_resultado[fonte_fosforo];
